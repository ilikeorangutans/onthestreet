...
function love.load()
  local w, h = love.window.getMode()
  --game = FlappyGame:new({speed = 2, minTimeBetweenObstacles=2,  jumpAmount=240, playersize = 32, gravity = 9.8, maxy = h - 20, miny = 20, minGapWidth = 200, minObstacleWidth = 40, maxObstacleWidth = 200})
  game = FlappyGame:new({maxy = h - 20, miny = 20})
end
